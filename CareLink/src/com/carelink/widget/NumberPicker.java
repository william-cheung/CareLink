...
public class NumberPicker extends LinearLayout {
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        //mInputText.setTextColor(context.getResources().getColor(R.color.black));
...
//        invalidate();
     ...
     */
    @SuppressLint("DefaultLocale") private int getSelectedPos(String value) {
        if (mDisplayedValues == null) {
            try {
    ...
    class AccessibilityNodeProviderImpl extends AccessibilityNodeProvider {
        ...
        @SuppressLint("DefaultLocale") private void findAccessibilityNodeInfosByTextInChild(String searchedLowerCase,
